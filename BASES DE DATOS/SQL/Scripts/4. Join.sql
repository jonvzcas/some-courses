...
INSERT INTO companies (name,id_legal_form,id_activity,company_value,date_start,id_city,address,phone,email,contact) VALUES 
	('TAR-get',4,7,100000000,'2000-03-30',11,'CL 13B # 2 - 77','4568545','contact@tar-get.com','Oilda'),
	('XYZ',4,4,80000000,'2002-05-17',8,'CR 15B # 9 - 78','9873254','contact@xyz.com','Okari'),
	('Almacen Pacifico',3,5,130000000,'2008-07-14',8,'AV 30 # 3 - 79','3543254','contact@almacenpacifico.com','Shi Yin'),
	('Constructora Asprilla',1,9,1500000000,'2005-05-19',11,'CL 6 # 40 - 80','5458765','contact@const-asprilla.com','Shu Yan'),
	('Comercializadora ABC',2,1,300000000,'2021-08-09',9,'CR 27C # 3 - 81','5458784','contact@comABC.com','Sol Amy'),
	('Bennet Company',4,7,90000000,'2019-01-18',9,'AV 10 # 4 - 82','8799336','contact@bennetcompany.com','Eliú'),
	('Bytes Colombia',1,7,90000000,'2019-06-19',11,'CL 66A # 4 - 44','8632134','contact@bytescolombia.com','Juny'),
	('Cafe Horizonte',3,6,250000000,'2021-03-05',10,'CR 47 # 9 - 84','2134545','contact@cafehorizonte.com','Ryan'),
	('Salud Tabaco',2,3,250000000,'2023-04-24',10,'AV 23D # 4 - 50','5646455','contact@saludtabaco.com','Ale José'),
	('Constructora ABC',1,8,1000000000,'2017-09-08',12,'CL 47B # 15 - 20','8769341','contact@constructoraABC.com','Alí Said'),
	('Arroz del Valle',3,2,1200000000,'2018-07-25',13,'CR 454 # 8 - 90','3917812','contact@arrozdelvalle.com','Dan José'),
	('Design Soft',1,7,150000000,'2016-10-15',12,'AV 14B # 4 - 77','7889715','contact@designsoft.com','UsNavy');
