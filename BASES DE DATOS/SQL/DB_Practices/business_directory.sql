...
-- Tiempo de generación: 11-07-2023 a las 20:39:12
...
(11, '0321', 'maritime aquaculture', NULL);
...
(50, 'TAR-get', 4, 7, 100000000, '2000-03-30', 1, 'CL 13B # 2 - 77', '4568545', 'contact@tar-get.com', 'Oilda'),
(51, 'XYZ', 4, 4, 80000000, '2002-05-17', 6, 'CR 15B # 9 - 78', '9873254', 'contact@xyz.com', 'Okari'),
(52, 'Almacen Pacifico', 3, 5, 130000000, '2008-07-14', 2, 'AV 30 # 3 - 79', '3543254', 'contact@almacenpacifico.com', 'Shi Yin'),
(53, 'Constructora Asprilla', 1, 9, 1500000000, '2005-05-19', 3, 'CL 6 # 40 - 80', '5458765', 'contact@const-asprilla.com', 'Shu Yan'),
(54, 'Comercializadora ABC', 2, 1, 300000000, '2021-08-09', 4, 'CR 27C # 3 - 81', '5458784', 'contact@comABC.com', 'Sol Amy'),
(55, 'Bennet Company', 4, 7, 90000000, '2019-01-18', 5, 'AV 10 # 4 - 82', '8799336', 'contact@bennetcompany.com', 'Eliú'),
(56, 'Bytes Colombia', 1, 7, 90000000, '2019-06-19', 6, 'CL 66A # 4 - 44', '8632134', 'contact@bytescolombia.com', 'Juny'),
(57, 'Cafe Horizonte', 3, 6, 250000000, '2021-03-05', 1, 'CR 47 # 9 - 84', '2134545', 'contact@cafehorizonte.com', 'Ryan'),
(58, 'Salud Tabaco', 2, 3, 250000000, '2023-04-24', 2, 'AV 23D # 4 - 50', '5646455', 'contact@saludtabaco.com', 'Ale José'),
(59, 'Constructora ABC', 1, 8, 1000000000, '2017-09-08', 3, 'CL 47B # 15 - 20', '8769341', 'contact@constructoraABC.com', 'Alí Said'),
(60, 'Arroz del Valle', 3, 2, 1200000000, '2018-07-25', 4, 'CR 454 # 8 - 90', '3917812', 'contact@arrozdelvalle.com', 'Dan José'),
(61, 'Design Soft', 1, 7, 150000000, '2016-10-15', 5, 'AV 14B # 4 - 77', '7889715', 'contact@designsoft.com', 'UsNavy');
...
--
ALTER TABLE `cities`
  MODIFY `id_city` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `companies`
--
ALTER TABLE `companies`
  MODIFY `id_company` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;
...
--
ALTER TABLE `legal_form`
  MODIFY `id_legal_form` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `sectors`
--
ALTER TABLE `sectors`
  MODIFY `id_sector` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
